<div>
    <h3 class="View_admin_segment01">View Brands</h3>
</div>
<table class="table table-bordered mt-5 text-center">
    <thead>
        <tr>
            <th class="admin_vw_prd_th" style="padding-top: 2%; padding-bottom:2%; background-color:#e6e5e0;">Serial Number</th>
            <th class="admin_vw_prd_th" style="padding-top: 2%; padding-bottom:2%; background-color:#e6e5e0;">Brand Name</th>
    ...
    <tbody class="text-light">
        ...
        ?>
            <tr>
                ...
                <td style="text-align: center; cursor:default;"><?php echo $brand_title; ?></td>
                <td style="text-align: center;"><a href='index.php?edit_brands=<?php echo $brand_id ?>' class='text-dark'><i class='fa-solid fa-pen-to-square'></i></a></td>
                <td style="text-align: center;"><a href='index.php?delete_brands=<?php echo $brand_id ?>' type="button" class="text-dark" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td>
            </tr>
        <?php
        }
        ?>
