...
<body>
    <div class="contain">
        <a href="index.php"><input type="submit" name="go_back" class="back_btn" value="Go Back"></a>
        <h3 class="View_admin_segment01">Add Products</h3>

        <!-- Form -->
        <form action="" method="post" enctype="multipart/form-data">
            <!-- title -->
            <div class="form-outline mt-5 mb-4 w-50 m-auto">
            ...
            <!-- price -->
            <div class="form-outline mb-4 w-50 m-auto">
                <input type="submit" name="insert_product" class="admin_add_prd_btn" value="Add Product">
            </div>
        </form>
    </div>
</body>
