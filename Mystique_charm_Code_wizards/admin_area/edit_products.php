...
<div  class="contain">
    <a href="index.php?view_products#view_products"><input type="submit" name="go_back" class="back_btn" value="Go Back"></a>
    <h3 class="View_admin_segment01">Edit Products</h3>

    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-outline w-50 m-auto mt-5 mb-4">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_brands" class="form-select">
                ...
                $brand_title = $row_category['category_title'];
        ...
        <div class="text-center">
            <input type="submit" name="edit_product" id="edit_product" value="Update Product" class="admin_add_prd_btn">
        </div>
    </form>
</div>
...
if (isset($_POST['edit_product'])) {
    ...
    if ($product_title == '' or $product_description == '' or $product_keywords == '' or $product_category == '' or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '') {
